...
export default function ExportMenu({ expenses, month }: Props) {
  ...
  function exportCSV() {
    ...
    a.href = url; a.download = `ledger-${month}.csv`; a.click();
  ...
  async function exportPDF() {
    ...
    doc.text(`Total: $${total.toFixed(2)} across ${expenses.length} transactions`, 14, 38);
    ...
    autoTable(doc, {
      ...
      styles: { fillColor: [15, 15, 26], textColor: [200, 192, 180], fontSize: 10 },
      headStyles: { fillColor: [22, 22, 40], textColor: [212, 168, 83], fontStyle: "bold" },
      alternateRowStyles: { fillColor: [12, 12, 22] },
      theme: "grid",
      gridLineWidth: 0.1,
      gridLineColor: [40, 40, 60],
    });
        ...
        <div style={{
          ...
          {[
            ...
            <button key={item.label} onClick={item.onClick} style={{
              ...
              color: "#c8c0b4", fontSize: 13, fontFamily: "inherit", textAlign: "left",
            }}
